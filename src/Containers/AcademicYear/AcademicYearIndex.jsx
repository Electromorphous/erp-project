...
function AcademicYearIndex() {
  ...
  const getData = async () => {
    let data = await Grid(
      "academic/fetchAllAcademic_yearDetail",
      "created_date"
    );
    setrows(data);
  };
  ...
  const handleActive = async (params) => {
    ...
    let endPoint = "";
    if (check === true) {
      endPoint = "academic/academic_year";
    } else {
      endPoint = "academic/activateAcademic_year";
    }
  ...
  return (
    <>
      <IndexCreateButton label="Create" path="/AcademicYearCreation" />
